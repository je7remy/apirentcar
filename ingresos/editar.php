...
if ($jwt) {
    // Si la decodificación es exitosa, mostrar detalles del ingreso
    try {
        // Establecer los valores de las propiedades del ingreso
        ...
        if ($success) {
            ...
            $json = array(
                "status"    => "true",
                "errCode"   => "00",
                "msg"       => "Error al actualizar datos del ingreso"
            );
            echo json_encode($json);
        }
    }
