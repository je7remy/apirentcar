<?php
    ...
    if ($jwt) {
        // Si la decodificación es exitosa, mostrar detalles de la reservacion
        try {
            // Establecer los valores de las propiedades de la reservacion
            ...
            if ($success) {
                ...
                $json = array(
                    "status"    => "true",
                    "errCode"   => "00",
                    "msg"       => "Error al actualizar datos de la reservacion"
                );
                echo json_encode($json);
            }
        }
