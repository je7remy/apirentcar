...
if ($jwt) {
    // Si la decodificación es exitosa, mostrar detalles de la reparacion
    try {
        // Establecer los valores de las propiedades de la reparacion
        ...
        if ($success) {
            ...
            $json = array(
                "status"    => "true",
                "errCode"   => "00",
                "msg"       => "Error al actualizar datos de la reparacion"
            );
            echo json_encode($json);
        }
    }
