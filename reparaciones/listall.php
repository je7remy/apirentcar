...
include_once 'reparacion.php'; // Cambio en la inclusión del archivo

// Obtener conexión a la base de datos
$database = new Database();
$db = $database->getConnection();

// Instanciar objeto reparacion
$reparacion = new Reparacion($db); // Cambio en la instancia del objeto
